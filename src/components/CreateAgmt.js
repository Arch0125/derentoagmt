        ...
        <Flex flexDirection={"column"} width={"80%"} p={'20px'} mt={'8%'} height={'fit-content'} bgColor={'white'} borderWidth={'2px'} rounded={'2xl'} borderColor={'blackAlpha.200'} boxShadow={'xl'}  >
            ...
            <Stack spacing={4} >
                ...
                <InputGroup mt={"20px"}>
                    ...
                    <Input onChange={e=>setTmail(e.target.value)} color={"blackAlpha.700"} borderColor={'gray.400'} />
                </InputGroup>
                <InputGroup mt={"20px"}>
            ...
            <Button onClick={createagmt} variant={"solid"} colorScheme={'purple'} color={'white'} mt={"40px"} >Publish on Blockchain 🚀</Button>
        </Flex>
     );
}
