...
contract Agreement{
    ...
    function addAgreement(address _tenant,string memory _lmail, string memory _tmail, string memory _amount, string memory _duration, string memory _productid, string memory _document) public {
        ++agmtcount;
        agreements[agmtcount] = Agmt(agmtcount, msg.sender,_tenant,_lmail,_tmail,_amount,_duration,_productid,_document,'Not Signed');
